...
<!--main content start-->
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>{$rptUserCustomers_User_Customers_Report}</h3>
        <div class="row mt">
          <div class="col-lg-12">
        ...
        <select class="form-control" onchange="RptGoto('rptUserCustomers',this.value)">
...
<div id="rptPrint">
            <div class="content-panel">
              ...
              <h4><i class="fa fa-angle-right"></i>{$rptUserCustomers_Report_Name_User_Customers}</h4>
              <h4><i class="fa fa-angle-right"></i> Report Date : {$reportDate}</h4>
