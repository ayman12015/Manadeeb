...
if(isset($_POST['UpdatePhoneUser']) && ($_POST['UpdatePhoneUser']!='')){
...
$smarty->assign('active_NewUserPhone',"active");
...
$smarty->display('company/NewUserPhone.tpl');
?>