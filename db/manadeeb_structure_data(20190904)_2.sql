...
(3, 'Add New Phone user', 'إضافة المناديب ', 'NewUserPhone.php', 'http://192.168.0.103/manadeeb/controllers/company/NewUserPhone.php', 2, 0),
(4, 'Add  new vonder', 'إضافة مورد جديد', 'Vendors.php', 'http://192.168.0.103/manadeeb/controllers/company/Vendors.php', 3, 0),
(5, 'add new package', 'إضافة المقايس أو الأوزان أو الاحجام ', 'Packages.php', 'http://192.168.0.103/manadeeb/controllers/company/Packages.php', 3, 0),
(6, 'Add  new product', 'إضافة منتج جديد', 'NewProduct.php', 'http://192.168.0.103/manadeeb/controllers/company/NewProduct.php', 3, 0),
(7, 'Pricing Products', 'إضافة سعر المنتج', 'PricingProducts.php', 'http://192.168.0.103/manadeeb/controllers/company/PricingProducts.php', 3, 0),
(8, 'Add  new customers', 'إضافة عميل جديد', 'AddNewCustomer.php', 'http://192.168.0.103/manadeeb/controllers/company/AddNewCustomer.php', 4, 0),
(9, 'add new customer class', 'إضافة تصنيف جديد للعملاء', 'CustomersClasse.php', 'http://192.168.0.103/manadeeb/controllers/company/CustomersClasse.php', 4, 0),
(10, 'customer classes configration', 'إعدادات تصنيف العملاء', 'ClassesConfigrations.php', 'http://192.168.0.103/manadeeb/controllers/company/ClassesConfigrations.php', 4, 0),
(11, 'customers classification', 'تصنيف العملاء', 'CustomersClassification.php', 'http://192.168.0.103/manadeeb/controllers/company/CustomersClassification.php', 4, 0),
(12, 'customers managment', 'إدارة العملاء للمناديب', 'CustomersManagement.php', 'http://192.168.0.103/manadeeb/controllers/company/CustomersManagement.php', 4, 0),
(13, 'create new store', 'إضافة مخزن جديد', 'CreateStore.php', 'http://192.168.0.103/manadeeb/controllers/company/CreateStore.php', 5, 0),
(14, 'Add  new product to store', 'إضافة منتج للمخزن', 'ProductsStore.php', 'http://192.168.0.103/manadeeb/controllers/company/ProductsStore.php', 5, 0),
(15, 'customers requests page', 'طلبات العملاء المسبقة', 'CustomersRequests.php', 'http://192.168.0.103/manadeeb/controllers/company/CustomersRequests.php', 6, 0),
(16, 'add new shipment', 'إضافة عملية شحن جديدة', 'NewShipmentment.php', 'http://192.168.0.103/manadeeb/controllers/company/NewShipmentment.php', 6, 0),
(17, 'finance page ', 'حسابات المناديب', 'Finance.php', 'http://192.168.0.103/manadeeb/controllers/company/Finance.php', 7, 0),
(18, 'active user web reports', 'تقرير لجميع مستخدمي نظام مناديب', 'rptActiveUsersWeb.php', 'http://192.168.0.103/manadeeb/controllers/company/rptActiveUsersWeb.php', 8, 0),
(19, 'user status report', 'تقرير حالة المستخدمين', 'rptActiveUsersPhone.php', 'http://192.168.0.103/manadeeb/controllers/company/rptActiveUsersPhone.php', 8, 0),
(20, 'user customers report', 'تقرير العملاء لكل مندوب', 'rptUserCustomers.php', 'http://192.168.0.103/manadeeb/controllers/company/rptUserCustomers.php', 8, 0),
(21, 'product package and price report', 'تقرير علي حسب المنتج', 'rptProductsPackagesPrice.php', 'http://192.168.0.103/manadeeb/controllers/company/rptProductsPackagesPrice.php', 8, 0),
(22, 'trucks and shipment report', 'تقرير بتاريخ العمليات  والمناديب', 'rptTrucksShipmentment.php', 'http://192.168.0.103/manadeeb/controllers/company/rptTrucksShipmentment.php', 8, 0),
(23, 'Receipts Payments Report', 'تقرير تفاصيل عمليات المندوب المالية', 'rptReceiptsPayment.php', 'http://192.168.0.103/manadeeb/controllers/company/rptReceiptsPayment.php', 8, 0),
(24, 'Customers Pending Bills Report', 'تقرير للمبالغ المتبقية علي المندوب', 'rptCustomersPendingBills.php', 'http://192.168.0.103/manadeeb/controllers/company/rptCustomersPendingBills.php', 8, 0),
(25, 'Customers Peformers Report', 'تقرير أداء  العملاء لدى المندوب', 'CrptCustomerPerformance.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptCustomerPerformance.php', 9, 0),
(26, 'Products Sales-General Report', 'تقرير عام لكل المبيعات بتاريخ محدد', 'CrptProductsSalesGeneral.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptProductsSalesGeneral.php', 9, 0),
(27, 'Products Sales (PerProduct) Report', 'تقرير لمبيعات منتج بتاريخ محدد', 'CrptProductsSalesPerProduc.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptProductsSalesPerProduc.php', 9, 0),
(28, 'Salesn Revenue (General)', 'تقرير الإيرادات بتاريخ محدد', 'CrptSalesRevenueGeneral.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptSalesRevenueGeneral.php', 9, 0),
(29, 'SalesRevenue(PerProduct)', 'تقرير إيرادات منتج  بتاريخ محدد', 'CrptSalesRevenuePerProduct.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptSalesRevenuePerProduct.php', 9, 0),
(30, 'System Setting', 'إعدادت نظام مناديب', 'SystemSetting.php', 'http://192.168.0.103/manadeeb/controllers/company/SystemSetting.php', 2, 0),
(31, 'Customers Location', 'قسم موقع العملاء علي الخريطة', 'google_maps.php', 'http://192.168.0.103/manadeeb/controllers/company/google_maps.php', 10, 0),
...
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `prod_avalable`;
...
(7, 'GetProduct.php', 'Get List of all customer avalable', 'Array\n(\n    [UserCompanyId] => 1\n    [UserPhone] => 00249924594681\n)\n'),
(6, 'GetProduct.php', 'Get List of all customer avalable', 'Array\n(\n    [UserCompanyId] => 1\n    [UserPhone] => 00249924594681\n)\n'),
(5, 'GetProduct.php', 'Get List of all customer avalable', 'Array\n(\n    [UserPhone] => 00249924594681\n    [UserCompanyId] => 1\n)\n'),
(8, 'GetProduct.php', 'Get List of all customer avalable', 'Array\n(\n    [UserCompanyId] => 1\n    [UserPhone] => 00249924594681\n)\n'),
(9, 'login.php', 'new login', 'Array\n(\n    [UserPhone] => 00249924594681\n    [UserPass] => Abc123**\n)\n'),
(10, 'GetProduct.php', 'Get List of all customer avalable', 'Array\n(\n    [UserCompanyId] => 1\n    [UserPhone] => 00249924594681\n)\n');
...
(8, 1, '30.000', '2019-08-29 13:26:13', 1, 10, 0);
...
(6, 8, '2000.000', '2019-09-04 18:55:59', 0);
