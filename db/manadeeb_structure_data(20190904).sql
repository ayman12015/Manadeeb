...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Sep 04, 2019 at 01:39 PM
...
(15, 'Ali Mohammed2', 'Ali2@gmail.com', '$2y$10$RZpvcBdLHMSWLbFYFIHG9evya47t3ERum9vfkH.9XQjPv2klJH1wC', '09245946811', 1, 0, 1, 1, 'EN', 0),
(16, 'myyy', 'mmmmm@gmail.com', '$2y$10$lpZAmUf0MJHw.dMHOvHc3.Kv/OUef6sA5kRZE6QZvLtH31h4LLt9W', '0999999999', 1, 1, 0, 1, 'EN', 0);
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  `msgRecipient` varchar(14) NOT NULL,
...
INSERT INTO `messages` (`msgId`, `msgBody`, `msgRecipient`, `msgStatus`) VALUES
(1, 'test fromtable 1', '249924594681', 1),
(2, 'test from table 2', '249924594681', 1),
(3, 'test test from table 3 test test from table 3 test test from table 3 test test from table 3 ', '249924594681', 1);
...
CREATE TABLE IF NOT EXISTS `messageslog` (
  ...
  `TimeCreated` varchar(60) NOT NULL,
...
(1, 'Dashboards', 'الشاشة الرئيسية', 'index.php', 'http://192.168.0.103/manadeeb/controllers/company/index.php', 1, 0),
(2, 'Add New User (Admin)', 'إضافة مستخدمي نظام مناديب', 'NewUser.php', 'http://192.168.0.103/manadeeb/controllers/company/NewUser.php', 2, 0),
(3, 'Add New Phone user', 'إضافة المناديب لنقاط البيع', 'NewUserPhone.php', 'http://192.168.0.103/manadeeb/controllers/company/NewUserPhone.php', 2, 0),
(4, 'Add  new vonder', 'Add  new vonder Arabic', 'Vendors.php', 'http://192.168.0.103/manadeeb/controllers/company/Vendors.php', 3, 0),
(5, 'add new package', 'add new package Arabic', 'Packages.php', 'http://192.168.0.103/manadeeb/controllers/company/Packages.php', 3, 0),
(6, 'Add  new product', 'Add  new product Arabic', 'NewProduct.php', 'http://192.168.0.103/manadeeb/controllers/company/NewProduct.php', 3, 0),
(7, 'Pricing Products', 'Pricing Products Arabic', 'PricingProducts.php', 'http://192.168.0.103/manadeeb/controllers/company/PricingProducts.php', 3, 0),
(8, 'Add  new customers', 'Add  new customers Arabic', 'AddNewCustomer.php', 'http://192.168.0.103/manadeeb/controllers/company/AddNewCustomer.php', 4, 0),
(9, 'add new customer class', 'add new customer class Arabic', 'CustomersClasse.php', 'http://192.168.0.103/manadeeb/controllers/company/CustomersClasse.php', 4, 0),
(10, 'customer classes configration', 'customer classes configration Arabic', 'ClassesConfigrations.php', 'http://192.168.0.103/manadeeb/controllers/company/ClassesConfigrations.php', 4, 0),
(11, 'customers classification', 'customers classification Arabic', 'CustomersClassification.php', 'http://192.168.0.103/manadeeb/controllers/company/CustomersClassification.php', 4, 0),
(12, 'customers managment', 'customers managment Arabic', 'CustomersManagement.php', 'http://192.168.0.103/manadeeb/controllers/company/CustomersManagement.php', 4, 0),
(13, 'create new store', 'create new store Arabic', 'CreateStore.php', 'http://192.168.0.103/manadeeb/controllers/company/CreateStore.php', 5, 0),
(14, 'Add  new product to store', 'Add  new product to store Arabic', 'ProductsStore.php', 'http://192.168.0.103/manadeeb/controllers/company/ProductsStore.php', 5, 0),
(15, 'customers requests page', 'customers requests page Arabic', 'CustomersRequests.php', 'http://192.168.0.103/manadeeb/controllers/company/CustomersRequests.php', 6, 0),
(16, 'add new shipment', 'add new shipment Arabic', 'NewShipmentment.php', 'http://192.168.0.103/manadeeb/controllers/company/NewShipmentment.php', 6, 0),
(17, 'finance page ', 'finance page Arabic ', 'Finance.php', 'http://192.168.0.103/manadeeb/controllers/company/Finance.php', 7, 0),
(18, 'active user web reports', 'active user web reports Arabic', 'rptActiveUsersWeb.php', 'http://192.168.0.103/manadeeb/controllers/company/rptActiveUsersWeb.php', 8, 0),
(19, 'user status report', 'user status report Arabic', 'rptActiveUsersPhone.php', 'http://192.168.0.103/manadeeb/controllers/company/rptActiveUsersPhone.php', 8, 0),
(20, 'user customers report', 'user customers report Arabic', 'rptUserCustomers.php', 'http://192.168.0.103/manadeeb/controllers/company/rptUserCustomers.php', 8, 0),
(21, 'product package and price report', 'product package and price report Arabic', 'rptProductsPackagesPrice.php', 'http://192.168.0.103/manadeeb/controllers/company/rptProductsPackagesPrice.php', 8, 0),
(22, 'trucks and shipment report', 'trucks and shipment report Arabic', 'rptTrucksShipmentment.php', 'http://192.168.0.103/manadeeb/controllers/company/rptTrucksShipmentment.php', 8, 0),
(23, 'Receipts Payments Report', 'Receipts Payments Report Arabic', 'rptReceiptsPayment.php', 'http://192.168.0.103/manadeeb/controllers/company/rptReceiptsPayment.php', 8, 0),
(24, 'Customers Pending Bills Report', 'Customers Pending Bills Report Arabic', 'rptCustomersPendingBills.php', 'http://192.168.0.103/manadeeb/controllers/company/rptCustomersPendingBills.php', 8, 0),
(25, 'Customers Peformers Report', 'Customers Peformers Report Arabic', 'CrptCustomerPerformance.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptCustomerPerformance.php', 9, 0),
(26, 'Products Sales-General Report', 'Products Sales-General Report Arabic', 'CrptProductsSalesGeneral.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptProductsSalesGeneral.php', 9, 0),
(27, 'Products Sales (PerProduct) Report', 'Products Sales (PerProduct) Report Arabic', 'CrptProductsSalesPerProduc.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptProductsSalesPerProduc.php', 9, 0),
(28, 'Salesn Revenue (General)', 'Salesn Revenue (General) Arabic', 'CrptSalesRevenueGeneral.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptSalesRevenueGeneral.php', 9, 0),
(29, 'SalesRevenue(PerProduct)', 'SalesRevenue(PerProduct) Arabic', 'CrptSalesRevenuePerProduct.php', 'http://192.168.0.103/manadeeb/controllers/company/CrptSalesRevenuePerProduct.php', 9, 0),
(30, 'System Setting', 'إعدادت لنظام مناديب', 'SystemSetting.php', 'http://192.168.0.103/manadeeb/controllers/company/SystemSetting.php', 2, 0),
(31, 'Customer Location', 'Customer Location Arabic', 'google_maps.php', 'http://192.168.0.103/manadeeb/controllers/company/google_maps.php', 10, 0),
(32, 'System Page(Ajax functions)', 'System Page(Ajax functions) Arabic', 'ajax_info.php', 'http://192.168.0.103/manadeeb/controllers/company/ajax_info.php', 0, 0),
(33, 'Home', 'الشاشه الاساسيه', 'Home.php', 'http://192.168.0.103/manadeeb/controllers/company/Home.php', 0, 0);
...
--
-- Table structure for table `prod_avalable`
--

DROP TABLE IF EXISTS `prod_avalable`;
CREATE TABLE IF NOT EXISTS `prod_avalable` (
  `prod_id` int(11) DEFAULT NULL,
  `prod_name` varchar(255) DEFAULT NULL,
  `manageable` int(11) DEFAULT NULL,
  ...
  `package_abbreviation` varchar(30) DEFAULT NULL,
  `ProdNamePackage` varchar(308) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(4, '2019-09-03 09:17:58', 1, 0, 10),
(3, '2019-09-03 09:17:58', 2, 0, 6),
(5, '2019-09-03 09:17:58', 3, 0, 6),
(6, '2019-09-03 09:17:58', 5, 0, 6),
(7, '2019-09-03 09:17:58', 5, 0, 6),
(8, '2019-09-03 09:17:58', 6, 0, 6),
(26, '2019-09-04 12:32:09', 3, 0, 6);
...
(41, 'AddCust.php', 'Add new Custoer', 'Array\n(\n)\n'),
(42, 'AddCust.php', 'Add new Custoer, sql', 'INSERT INTO customers (cust_name,cust_mobile,cust_shop_name,location_id,user_id,weekId,company_id,entered_by)  VALUES (\'Cus_New_ID\',\'1234567890\',\'Null_Shop_Name\',\'0\',\'\',\'3\',\'\',\'\')');
